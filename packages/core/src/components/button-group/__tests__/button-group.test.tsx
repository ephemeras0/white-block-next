  ...
  describe('## Base', () => {
    it('### default config', () => {
      ...
      expect(wrapper.classes()).toEqual([
        'wb-button-group',
        'wb-button-group--base',
        'wb-button-group--primary',
        'wb-button-group--md',
        'wb-button-group--rectangle',
        'wb-button-group-gap--md'
      ])
      expect(wrapper.findAllComponents({ name: 'WbButton' }).length).toBe(3)
